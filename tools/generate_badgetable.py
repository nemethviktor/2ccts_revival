...
item (FEAT_BADGES, {power_underlined}) {{
    property {{
        ...
        if '_' in power_underlined:
            content.append(
                f"""\n\tgraphics {{default: sprite_{power_underlined.replace('power_', '')};}}\n""")
        content.append(f"}}\n")
